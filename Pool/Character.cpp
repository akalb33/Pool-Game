...
Character::Character(const std::type_info& type)
   ...
   , mPolygon()
   , mType(type)
   , mPreviousX(0.123499f) // The random number guarantees that the first time Collision() 
   , mPreviousY(0.123499f) //    is called, the polygon points will be adjusted.
   , mPreviousAngle(-mAngle)
   , mPreviousScale(-mScale)
   , mUseSFMLScaling(false)
{
}
