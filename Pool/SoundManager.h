...
public:
   ...
   SoundManager()
   {
     AddSound(ballCollision, "ballHit.wav");
     AddSound(stickCollision, "cuestickhit.wav", 100.0f, false, 0.9f);
     AddSound(pocketDrop, "pocketDrop.wav", 20.0f);
     AddSound(cushion, "cushion.wav");
   }
